...
start later than musicians do, that's the career of JS Bach or the band Kiss
...
in that period, together with thoughts on why the work is important. 
...
friendly and unfriendly competitors, and people he inspired to work on protein
...
of acquaintances. That club had amazing privileges, far-flung members. Gunny
...
protein to be consumed before a single experiment was complete. Gunny
...
Hans wasn't the first to find myoglobin a congenial protein to work with.
Myoglobin from sperm whales forms big, beautiful crystals, and that had caught
the a ttention of John Kendrew back in 1952 when he and Max Perutz were working
toward s the first crystal structure of a protein. When they finally obtained
the struc ture of myoglobin, it was both exciting and ugly. Where the structure
of DNA was like a cathedral window, myoglobin resembled entrails left behind by
a dog.
...
biologist s any easier. It might have helped if we had anchored the biological
...
1. **Proteins fluctuate among a network of conformations.** Myoglobin has >50
   accessible conformations, with millisecond lifetimes at physiological
   temperatures.  The network appears hierarchical when viewed through
   function because changes closer to the active site have greater functional
   effects.

 2. **Conformations are determined by waters and protons surrounding the protein.** 
    Some conformations are pH- and pressure-dependent; these arise
    from doubly-protonated residues which blow open the protein structure and
    which help stability protein structure.
...
4. **Motions in proteins are classified as either transitions in the
   conformational network or slaved to the solvent.** Conformational changes
   like aggregation are same in every protein. Slaved motions are large-scale
   like those of unfolding, and stop when the solvent freezes.
...
t them all right. There are also unpublished results that I'm not at liberty to
discuss.
...
- **Structure prediction:** The structure prediction method AlphaFold from Deep
  ...
  in science. There is general hope (with several startups based on that hope)
...
- **Storing biologics:** Half a trillion dollars worth of protein drugs are
  ...
  at -80 Â°C. Distinguishing aggregation from unfolding is valuable.
...
- **Understanding:** There are fundamental forces of biology that govern
  structure at levels from protein conformation upwards to protein assemblies,
  tissues, and organs. These forces involve water, protons, and their
  interactions with protein surfaces.
